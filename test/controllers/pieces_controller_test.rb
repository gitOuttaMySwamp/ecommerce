...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { detailId: @piece.detailId, dimensions: @piece.dimensions, image: @piece.image, name: @piece.name, price: @piece.price, sizeId: @piece.sizeId } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { detailId: @piece.detailId, dimensions: @piece.dimensions, image: @piece.image, name: @piece.name, price: @piece.price, sizeId: @piece.sizeId } }
